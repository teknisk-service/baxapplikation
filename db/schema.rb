...
ActiveRecord::Schema.define(version: 20190716181540) do
  ...
  create_table "teams", force: :cascade do |t|
    ...
    t.string "debters", default: [], array: true
    t.string "order_items", default: [], array: true
    t.string "orders", default: [], array: true
    t.string "outlays", default: [], array: true
    t.string "payments", default: [], array: true
    t.string "products", default: [], array: true
    t.string "shared_purchases", default: [], array: true
  end
